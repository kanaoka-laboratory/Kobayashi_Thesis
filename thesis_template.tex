...
調査の結果、調査を行なったアプリ数109251個の中45305個のアプリにIPv4アドレスの記載があることが分かった。
以下の表に、出現数の多いIPアドレス別の結果をまとめた。
\begin{table}[htb]
  \begin{center}
    \caption{最も多いIPアドレス1〜20}
    \begin{tabular}{|l|c|} \hline
      IPアドレス & アプリ数 \\ \hline \hline
...
2.5.4.8 & 3186 \\ \hline
2.5.4.7 & 3183 \\ \hline
2.5.29.37 & 3065 \\ \hline
10.0.2.2 & 2878 \\ \hline
2.5.29.19 & 2876 \\ \hline
1.4.1.19 & 2762 \\ \hline
2.0.61.0 & 2758 \\ \hline
2.5.4.4 & 2360 \\ \hline
2.5.4.42 & 2354 \\ \hline
...
10.0.0.172 & 29074 &  26.6\%\\ \hline
IPアドレスの記載のあるアプリ数 & プライベートIPアドレス記載があるアプリ数 &　割合率　\\ \hline 
10.0.0.172 & 35151 &  26.6\%\\ \hline
    \end{tabular}
    \label{tab:price}
  \end{center}
\end{table}
